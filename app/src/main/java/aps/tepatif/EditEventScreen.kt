...
//                        isStartSelected = false
            ...
            Button(
                onClick = { showChangeConfirm.value = true },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 16.dp)
                    .height(48.dp),
//                    .padding(start = 16.dp, bottom = 16.dp, end = 16.dp),
    ...
    if (showChangeConfirm.value) {
        ConfirmWindow(
            navController = navController,
            showDialog = showChangeConfirm.value,
            title = "Are you sure to\nChange this Event?",
            onDismiss = { showChangeConfirm.value = false },
            onConfirm = {
                showChangeConfirm.value = false
                navController.navigate("home_screen")
            },
            onCancel = { showChangeConfirm.value = false }
        )
    }
}
